...
<head>
    ...
    <title>Clôtures de caisse | Askya Finance</title>
    ...
    <div class="main-content">
        <div class="table-card">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h4><i class="fas fa-cash-register me-2"></i>Historique des clôtures de caisse</h4>
                <a href="{{ route('caissier.cash-closes.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus me-2"></i>Nouvelle clôture
                </a>
            </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('caissier.cash-closes.show', $cashClose->id) }}" class="btn btn-sm btn-primary">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                ...
                                <p class="text-muted">Aucune clôture de caisse trouvée</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
