...
<div class="alert-custom alert-custom-success d-flex flex-column flex-md-row justify-content-between align-items-md-center p-4 rounded-4 mb-4 gap-3">
    ...
    <form action="{{ route('caissier.caisse.fermer') }}" method="POST">
        @csrf
        <button type="submit" class="btn-custom btn-custom-danger py-2.5 px-4 w-100">
