...
<head>
    ...
    <title>Modifier l'utilisateur | Askya Finance</title>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <div class="page-title">
                <h1><i class="fas fa-edit me-2"></i>Modifier l'utilisateur</h1>
                <p>Modifiez les informations de {{ $user->name }}</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="first_name" name="first_name" value="{{ old('first_name', $user->first_name) }}" required placeholder="Entrez le prénom">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="last_name" class="form-label">Nom</label>
                        <input type="text" class="form-control" id="last_name" name="last_name" value="{{ old('last_name', $user->last_name) }}" required placeholder="Entrez le nom">
                    </div>
                </div>

                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $user->email) }}" required placeholder="exemple@askya-finance.com">
                </div>
