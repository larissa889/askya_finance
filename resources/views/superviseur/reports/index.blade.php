...
<body>
    ...
    <div class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('superviseur.reports.index') }}" class="active">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="stat-card info">
                    ...
                    <h3>{{ number_format($statistiques['montant_total'], 0, ',', ' ') }}</h3>
        ...
        <div class="row">
            <div class="col-lg-6 mb-4">
                <div class="chart-card">
                    <h4><i class="fas fa-chart-line me-2"></i>Transactions par jour</h4>
